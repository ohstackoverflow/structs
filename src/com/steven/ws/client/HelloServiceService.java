 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://webservice.steven.com/", wsdlLocation = "http://192.168.100.106:1234/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://webservice.steven.com/", "HelloServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.100.106:1234/server?wsdl");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://webservice.steven.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.steven.com/", "HelloServicePort"), HelloService.class, features);
    }
